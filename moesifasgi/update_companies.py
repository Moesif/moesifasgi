...
class Company:
    ...
    def update_company(cls, company_profile, api_client, DEBUG):
        if not company_profile:
            if DEBUG:
                logger.info('Expecting the input to be either of the type - CompanyModel, dict or json while updating company')
        else:
            if isinstance(company_profile, dict):
                if 'company_id' in company_profile:
                    ...
                    if DEBUG:
                        logger.info('To update an company, an company_id field is required')
                ...
                try:
                    ...
                    if 'company_id' in company_profile_json:
                        ...
                        if DEBUG:
                            logger.info('To update a company, an company_id field is required')
                except:
    ...
    def update_companies_batch(cls, company_profiles, api_client, DEBUG):
        if not company_profiles:
            logger.info('Expecting the input to be either of the type - List of CompanyModel, dict or json while updating companies')
        else:
